...
% using docsteady version 1.2rc12.post3+gf127be3.d20200706
...
The adopted Coverage definition are described bellow.
These definitions are valid for both  Verification Elements and Requirements.
In the case of Verification Elements, these definitions DO NOT correspond to the
statuses defined in the Verification Element's Workflow in Jira.
The main reason for this deviation is that, the VE status needs to be update manually,
implying that in the majority of the cases, the status of a VE do not reflect the reality.
